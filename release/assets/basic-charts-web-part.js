define("7d95956f-1438-4c6e-bcb1-79a923ee1727_0.0.1", ["react","react-dom","@microsoft/sp-core-library","@microsoft/sp-property-pane","@microsoft/sp-webpart-base","BasicChartsWebPartStrings","@microsoft/sp-http"], (__WEBPACK_EXTERNAL_MODULE__650__, __WEBPACK_EXTERNAL_MODULE__729__, __WEBPACK_EXTERNAL_MODULE__878__, __WEBPACK_EXTERNAL_MODULE__723__, __WEBPACK_EXTERNAL_MODULE__134__, __WEBPACK_EXTERNAL_MODULE__530__, __WEBPACK_EXTERNAL_MODULE__272__) => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ 214:
/*!************************************************************!*\
  !*** ./lib/webparts/basicCharts/components/BasicCharts.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BasicCharts)
/* harmony export */ });
...
/* harmony import */ var react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-chartjs-2 */ 939);
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! chart.js */ 128);
...
chart_js__WEBPACK_IMPORTED_MODULE_2__.Chart.register(chart_js__WEBPACK_IMPORTED_MODULE_2__.ArcElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.Tooltip, chart_js__WEBPACK_IMPORTED_MODULE_2__.Legend, chart_js__WEBPACK_IMPORTED_MODULE_2__.CategoryScale, chart_js__WEBPACK_IMPORTED_MODULE_2__.LinearScale, chart_js__WEBPACK_IMPORTED_MODULE_2__.BarElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.Title, chart_js__WEBPACK_IMPORTED_MODULE_2__.LineElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.PointElement, chart_js__WEBPACK_IMPORTED_MODULE_2__.RadialLinearScale, chart_js__WEBPACK_IMPORTED_MODULE_2__.TimeScale // Important for scatter plot with time axis
);
function BasicCharts(props) {
    var _this = this;
    var _a = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]), grades = _a[0], setGrades = _a[1];
    var _b = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''), error = _b[0], setError = _b[1];
    var _c = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('pie'), activeTab = _c[0], setActiveTab = _c[1];
    var loadGrades = function () { return __awaiter(_this, void 0, void 0, function () {
        var listUrl, response, data, error_1, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    listUrl = "".concat(props.context.pageContext.web.absoluteUrl, "/_api/web/lists/getbytitle('Grades-N-Such')/items?$select=ID,Title,Grade,Date");
                    return [4 /*yield*/, props.context.spHttpClient.get(listUrl, _microsoft_sp_http__WEBPACK_IMPORTED_MODULE_1__.SPHttpClient.configurations.v1, {
                            headers: {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
        loadGrades().catch(function (error) {
    ...
    var pieChartData = {
        labels: grades.map(function (grade) { return grade.Title; }),
        datasets: [{
                data: grades.map(function (grade) { return grade.Grade; }),
    ...
    var radarChartData = {
        ...
        datasets: [{
                label: 'Grade',
                data: grades.map(function (grade) { return grade.Grade; }),
                backgroundColor: "".concat(colors[3], "44"),
    ...
    var scatterChartData = {
        datasets: [{
                ...
                data: grades.map(function (grade) { return ({
                    x: new Date(grade.Date).valueOf(),
                    y: grade.Grade
                }); }),
    ...
    var scatterChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: {
                display: true,
                text: 'Grades by Date'
            } }), scales: {
            x: {
    ...
    var polarChartData = {
        ...
        datasets: [{
                data: grades.map(function (grade) { return grade.Grade; }),
                backgroundColor: polarColors.map(function (color) { return "".concat(color, "88"); }),
                borderColor: polarBorderColors,
                borderWidth: 2
            }]
    };
    // Chart-specific options
    var pieChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Distribution (Pie)' } }) });
    var barChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Distribution (Bar)' } }), scales: {
            y: {
                beginAtZero: true,
                max: 100
            }
        } });
    var lineChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Progression' } }), scales: {
            y: {
                beginAtZero: true,
                max: 100
            }
        } });
    var radarChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Radar Analysis' } }), scales: {
            r: {
                beginAtZero: true,
                max: 100
            }
        } });
    var doughnutChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Distribution (Doughnut)' } }) });
    var polarChartOptions = __assign(__assign({}, commonOptions), { plugins: __assign(__assign({}, commonOptions.plugins), { title: { display: true, text: 'Grade Distribution (Polar)' } }) });
    var tabStyle = {
        padding: '8px 16px',
        margin: '0 2px',
        border: 'none',
    ...
    var activeTabStyle = __assign(__assign({}, tabStyle), { backgroundColor: '#f0f0f0', borderBottom: '2px solid #0078d4' });
    var inactiveTabStyle = __assign(__assign({}, tabStyle), { backgroundColor: '#e0e0e0', borderBottom: '2px solid transparent' });
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "SPFX and Chart.js"),
        error && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { color: 'red', marginBottom: '1em' } },
            "Error: ",
            error),
        grades.length === 0 && !error && react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "Loading..."),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { marginBottom: '20px', borderBottom: '1px solid #ccc', display: 'flex', flexWrap: 'wrap' } }, [
        ...
        ].map(function (tab) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", { key: tab.id, style: activeTab === tab.id ? activeTabStyle : inactiveTabStyle, onClick: function () { return setActiveTab(tab.id); } }, tab.label)); })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { minHeight: '400px', marginBottom: '2em' } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { maxWidth: '800px', margin: '0 auto' } },
                activeTab === 'pie' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Pie, { data: pieChartData, options: pieChartOptions }),
                activeTab === 'bar' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Bar, { data: barChartData, options: barChartOptions }),
                activeTab === 'line' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Line, { data: lineChartData, options: lineChartOptions }),
                activeTab === 'radar' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Radar, { data: radarChartData, options: radarChartOptions }),
                activeTab === 'scatter' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Scatter, { data: scatterChartData, options: scatterChartOptions }),
                activeTab === 'doughnut' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.Doughnut, { data: doughnutChartData, options: doughnutChartOptions }),
                activeTab === 'polar' && react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_3__.PolarArea, { data: polarChartData, options: polarChartOptions }))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { border: '1px solid #ccc', padding: '10px' } },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("table", { style: { width: '100%', borderCollapse: 'collapse' } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("thead", null,
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", null,
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", { style: { border: '1px solid #ddd', padding: '8px', textAlign: 'left' } }, "ID"),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", { style: { border: '1px solid #ddd', padding: '8px', textAlign: 'left' } }, "Title"),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", { style: { border: '1px solid #ddd', padding: '8px', textAlign: 'left' } }, "Grade"),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("th", { style: { border: '1px solid #ddd', padding: '8px', textAlign: 'left' } }, "Date"))),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("tbody", null, grades.map(function (grade) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("tr", { key: grade.ID },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", { style: { border: '1px solid #ddd', padding: '8px' } }, grade.ID),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", { style: { border: '1px solid #ddd', padding: '8px' } }, grade.Title),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", { style: { border: '1px solid #ddd', padding: '8px' } }, grade.Grade),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("td", { style: { border: '1px solid #ddd', padding: '8px' } }, new Date(grade.Date).toLocaleDateString()))); })))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { style: { marginTop: '1em' } },
            "Total records: ",
            grades.length)));
}
...
/***/ 530:
/*!********************************************!*\
  !*** external "BasicChartsWebPartStrings" ***!
  \********************************************/
/***/ ((module) => {
...
/* harmony export */ });
/* unused harmony exports Animation, Animations, BasePlatform, BasicPlatform, Colors, DatasetController, Decimation, DomPlatform, Element, Filler, Interaction, LogarithmicScale, Scale, SubTitle, TimeSeriesScale, _adapters, _detectPlatform, animator, controllers, elements, layouts, plugins, registerables, registry, scales */
/* harmony import */ var _chunks_helpers_dataset_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunks/helpers.dataset.js */ 373);
/*!
 * Chart.js v4.4.9
...
/* harmony export */ });
/* unused harmony exports a$, aR, aS, aT, aU, aV, aW, aX, aY, aZ, a_, b0, b1, b2, b3, b4, b5, b6, b7 */
/* harmony import */ var _kurkle_color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @kurkle/color */ 337);
/*!
 * Chart.js v4.4.9
 * https://www.chartjs.org
 * (c) 2025 Chart.js Contributors
...
/* harmony export */ });
/* unused harmony exports Bubble, Chart, getDatasetAtEvent, getElementAtEvent, getElementsAtEvent */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ 650);
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! chart.js */ 128);
...
(() => {
/*!********************************************************!*\
  !*** ./lib/webparts/basicCharts/BasicChartsWebPart.js ***!
  \********************************************************/
...
/* harmony import */ var BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! BasicChartsWebPartStrings */ 530);
/* harmony import */ var BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_BasicCharts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/BasicCharts */ 214);
...
var BasicChartsWebPart = /** @class */ (function (_super) {
    __extends(BasicChartsWebPart, _super);
    function BasicChartsWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BasicChartsWebPart.prototype.render = function () {
        var element = react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_BasicCharts__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    BasicChartsWebPart.prototype.onDispose = function () {
        react_dom__WEBPACK_IMPORTED_MODULE_1__.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(BasicChartsWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    BasicChartsWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5__.PropertyPaneDescription
                    },
                    groups: [
                        {
                            groupName: BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5__.BasicGroupName,
                            groupFields: [
                                (0,_microsoft_sp_property_pane__WEBPACK_IMPORTED_MODULE_3__.PropertyPaneTextField)('description', {
                                    label: BasicChartsWebPartStrings__WEBPACK_IMPORTED_MODULE_5__.DescriptionFieldLabel
                                })
                            ]
                        }
                    ]
    ...
    return BasicChartsWebPart;
}(_microsoft_sp_webpart_base__WEBPACK_IMPORTED_MODULE_4__.BaseClientSideWebPart));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BasicChartsWebPart);
...
//# sourceMappingURL=basic-charts-web-part.js.map